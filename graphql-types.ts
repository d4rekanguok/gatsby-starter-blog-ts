...
export type BioQueryQuery = { avatar: Maybe<{ childImageSharp: Maybe<{ fixed: Maybe<GatsbyImageSharpFixedFragment> }> }>, site: Maybe<{ siteMetadata: Maybe<(Pick<SiteSiteMetadata, 'author'> & { social: Maybe<Pick<SiteSiteMetadataSocial, 'twitter'>> })> }> };
...
export type BlogIndexQuery = { site: Maybe<{ siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, allMarkdownRemark: Maybe<{ edges: Array<{ node: (Pick<MarkdownRemark, 'excerpt'> & { fields: Maybe<Pick<MarkdownRemarkFields, 'slug'>>, frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'date' | 'title' | 'description'>> }) }> }> };
...
export type BlogPostBySlugQuery = { site: Maybe<{ siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title' | 'author'>> }>, markdownRemark: Maybe<(Pick<MarkdownRemark, 'id' | 'excerpt' | 'html'> & { frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'date' | 'description'>> })> };
